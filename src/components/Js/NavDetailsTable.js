...
class NavDetails extends Component {
    state = { 
     ...
     componentDidMount=()=>{
        ...
        console.log("navTableProps",this.props)
     }
    ...
    render() { 
        ...
        return ( 
            ...
            <tr>
                ...
                <td>{this.props.tzurData.accuredInterest.toFixed(0).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</td>
            </tr>	
            <tr>
            ...
            <tr>
                ...
                <td>{this.props.tzurData.lossPorvision.toFixed(0).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</td>
            </tr>
            <tr>
                ...
                <td>{this.props.tzurData.monthlyAmortization.toFixed(0).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</td>
            </tr>
            <tr>
